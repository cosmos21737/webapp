...
```
cd existing_repo
git remote add origin https://intern.jpt.jgc.com/masaki.kumagai/quest_1.git
git branch -M main
...
- [ ] [Set up project integrations](https://intern.jpt.jgc.com/masaki.kumagai/quest_1/-/settings/integrations)
